...
def getMassDistroDY():
	...
	result.Scale(10)  # bc dimuon DY only has 10000 events
	return result
...
def main():
	...
	if resolution:	
		if muon:
			canv.Print("plots/MassHist_combine_Muon.pdf")
		else:	
			canv.Print("plots/MassHist_combine_Electron.pdf")
	else:
		canv.Print("plots/MassHist_combine.pdf")
